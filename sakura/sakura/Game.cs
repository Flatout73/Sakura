    ...
    public class Game : Microsoft.Xna.Framework.Game
    {
       ...
       LevelManager LevelManager = new LevelManager();
        ...
        protected override void Initialize()
        {
            ...
            buttonHelp = new Button(resX / 2f - (float)helpTexture.Width * (256f * kx / (float)helpTexture.Width) / 2f, (float)resY - 2*(helpTexture.Height * (256f * kx / (float)helpTexture.Width) / 2f) + 4 * kx, kx, new Vector2(helpTexture.Width * (256f / (float)helpTexture.Width), helpTexture.Height * (256f / (float)helpTexture.Width)));
